...
<p class="wg-actions">{% include button.html href="https://dailymarkettracker-jrnxjbmkxitvegoascnxk4.streamlit.app/" text="Open the live dashboard" accent="lab" external=true %}</p>
