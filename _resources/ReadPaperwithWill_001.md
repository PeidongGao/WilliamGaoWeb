...
type: papers
topics: [reading, endocrinology, single-cell]
date: 2026-07-26
status: published
...
<nav class="read-paper__story-map" aria-labelledby="story-map-title">
  <p class="read-paper__ui-label" id="story-map-title">The Story</p>
  <ol>
    <li><a href="#build-the-atlas"><span>01</span> Build the atlas</a></li>
    <li><a href="#map-hormone-producers"><span>02</span> Map hormone producers</a></li>
    <li><a href="#map-hormone-receivers"><span>03</span> Map hormone receivers</a></li>
    <li><a href="#explore-adipocyte-remodeling"><span>04</span> Explore adipocyte remodeling</a></li>
    <li><a href="#connect-genes-with-disease"><span>05</span> Connect genes with disease</a></li>
  </ol>
</nav>
...
- SCT/secretin expression in plasmacytoid dendritic cells (pDCs), supported by transcript- and protein-level evidence ([Figures 2E and 2G–J](https://doi.org/10.1126/science.aeb2672))
...
<p class="read-paper__bridge">The atlas was then used to connect monogenic disease genes with specific cellular and anatomical contexts.</p>
<section class="read-paper__chapter" id="connect-genes-with-disease" markdown="1">
<p class="read-paper__chapter-label">05 · Connect genes with disease</p>
